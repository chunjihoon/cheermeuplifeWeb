...
const faqItems = [
  ...
  { question: "질풍가도 완전정복 클래스에는 무엇이 포함되나요?", answer: "파트별 동작 강의와 0.3·0.5·0.7·1배속 완곡 연습을 포함한 총 9개 영상 (약 1시간 58분) 분량으로 구성되어 있습니다." },
  { question: "클래스는 어떻게 시청하나요?", answer: "계좌이체 방식의 경우 입금 확인 후 구매 시 입력한 Gmail 계정으로 Google Drive 폴더 이용 권한을 보내드립니다. 탈잉이나 리틀리에서 결제하실 경우 해당 플랫폼에서 바로 결제하고 시청하실 수 있습니다." },
  { question: "클래스 이용 기간이 있나요?", answer: "탈잉에서 결제하실 경우 12개월 이용 가능하고 계좌이체 또는 리틀리에서 결제하실 경우 평생소장입니다." },
  { question: "클래스 영상이나 링크를 팀원에게 공유해도 되나요?", answer: "아니요. 영상 파일과 Google Drive 링크는 구매자 본인만 이용할 수 있으며 공유·복제·재판매·재배포할 수 없습니다." },
  { question: "클래스 결제 후 환불할 수 있나요?", answer: "Google Drive 이용 권한 제공 전에는 환불을 요청할 수 있습니다. 제공 이후에는 디지털 콘텐츠 특성상 단순 변심 환불이 제한될 수 있으며, 자세한 내용은 이용약관을 확인해주세요." },
