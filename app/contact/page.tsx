...
export const metadata: Metadata = createMetadata({
  title: "문의",
  description: "치어리딩 레슨, 질풍가도 VOD 구매, 학교 축제·행사·협업 및 일반 문의 방법을 안내합니다.",
  path: "/contact",
});

const contacts = [
  ["레슨 문의", "개인·단체 레슨, 온라인 수업과 원하는 곡의 안무 학습에 대해 문의해주세요.", "/#products", "레슨 상품 확인"],
  ["VOD 구매 문의", "질풍가도 VOD 구성, 계좌이체 주문과 Google Drive 이용에 대해 안내합니다.", "/vod-tutorial#purchase", "VOD 구매 안내"],
  ["협업·행사 문의", "학교 축제, 체육대회, 기업 행사, 축하공연과 콘텐츠 협업을 문의할 수 있습니다.", `mailto:${siteConfig.email}?subject=${encodeURIComponent("[협업·행사 문의] ")}`, "이메일 보내기"],
