  ...
  return (
    <main className="content-page">
      ...
      <article className="content-narrow content-prose">
        <h2>1. 수집하는 개인정보</h2><p>서비스 이용 과정에서 아래 정보가 수집될 수 있습니다.</p><ul><li>레슨 예약: 신청 서비스, 이름 또는 단체명, 이메일 주소, 연락처, 희망 일정 3개, 희망 지역, 인원, 요청사항</li><li>공연·행사 문의: 담당자 이름, 소속·기관명, 이메일 주소, 행사 예정일, 지역·장소, 행사 종류, 문의 내용</li><li>응원 크루 지원: 이름, 출생연도, 성별, 연락처, 이메일 주소, 거주지역, 액션 치어리딩 활동경력, 현재 활동 상태, 공연 참여 가능 시간, 수도권 공연 및 첫 공연 참여 가능 여부, 활동 영상·SNS와 지원자가 직접 작성한 지원 관련 내용</li><li>클래스 구매: 입금자명, Google Drive 초대용 Gmail 주소, 주문번호, 결제 금액과 주문 상태</li><li>일반 문의: 이메일 주소와 문의자가 직접 작성한 내용</li><li>서비스 이용 기록: 접속 및 이벤트 이용 기록 등 분석 도구를 통해 생성되는 정보</li></ul>
        <h2>2. 개인정보 이용 목적</h2><ul><li>레슨 일정 협의와 예약 처리</li><li>공연·행사 가능 여부 확인과 섭외 협의</li><li>응원 크루 지원 내용 검토, 활동 적합성 확인과 1:1 온라인 미팅을 위한 개별 연락</li><li>클래스 입금 확인과 Google Drive 이용 권한 제공</li><li>문의 답변과 고객 지원</li><li>서비스 오류 확인과 이용 현황 분석</li><li>부정 이용 방지와 분쟁 대응</li></ul>
        ...
        <p className="content-meta">시행일: 2026년 7월 15일 · 최종 수정일: 2026년 9월 17일</p>
      </article>
    </main>
  );
}
