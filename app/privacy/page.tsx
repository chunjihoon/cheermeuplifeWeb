...
export const metadata: Metadata = createMetadata({ title: "개인정보처리방침", description: "취미로운응원생활의 레슨 예약, 문의와 클래스 구매 과정에서 처리되는 개인정보와 이용자 권리를 안내합니다.", path: "/privacy" });
  ...
  return (
    <main className="content-page">
      ...
      <article className="content-narrow content-prose">
        <h2>1. 수집하는 개인정보</h2><p>서비스 이용 과정에서 아래 정보가 수집될 수 있습니다.</p><ul><li>레슨 예약: 신청 서비스, 이름 또는 단체명, 이메일 주소, 연락처, 희망 일정 3개, 희망 지역, 인원, 요청사항</li><li>공연·행사 문의: 담당자 이름, 소속·기관명, 이메일 주소, 행사 예정일, 지역·장소, 행사 종류, 문의 내용</li><li>클래스 구매: 입금자명, Google Drive 초대용 Gmail 주소, 주문번호, 결제 금액과 주문 상태</li><li>일반 문의: 이메일 주소와 문의자가 직접 작성한 내용</li><li>서비스 이용 기록: 접속 및 이벤트 이용 기록 등 분석 도구를 통해 생성되는 정보</li></ul>
        <h2>2. 개인정보 이용 목적</h2><ul><li>레슨 일정 협의와 예약 처리</li><li>공연·행사 가능 여부 확인과 섭외 협의</li><li>클래스 입금 확인과 Google Drive 이용 권한 제공</li><li>문의 답변과 고객 지원</li><li>서비스 오류 확인과 이용 현황 분석</li><li>부정 이용 방지와 분쟁 대응</li></ul>
        ...
        <h2>4. 외부 서비스 제공자</h2><p>사이트 운영을 위해 다음 외부 서비스를 사용합니다.</p><ul><li>Google Firebase·Firestore: 예약, 후기와 클래스 주문 정보 저장 및 서비스 운영</li><li>Firebase Analytics·Google Analytics: 사이트 이용 현황 분석</li><li>이메일 전송 서비스: 예약 및 주문 알림</li><li>YouTube: 영상 콘텐츠 임베드 및 공식 채널 연결</li><li>Vercel: 웹사이트 호스팅 및 서버 기능 제공</li></ul><p>각 서비스 제공자는 자체 개인정보처리방침에 따라 데이터를 처리할 수 있습니다.</p>
