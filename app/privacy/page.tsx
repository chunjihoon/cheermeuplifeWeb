  ...
  return (
    <main className="content-page">
      ...
      <article className="content-narrow content-prose">
        <h2>1. 수집하는 개인정보</h2><p>서비스 이용 과정에서 아래 정보가 수집될 수 있습니다.</p><ul><li>레슨 예약: 신청 서비스, 이름 또는 단체명, 이메일 주소, 연락처, 희망 일정 3개, 희망 지역, 인원, 요청사항</li><li>클래스 구매: 입금자명, Google Drive 초대용 Gmail 주소, 주문번호, 결제 금액과 주문 상태</li><li>일반 문의: 이메일 주소와 문의자가 직접 작성한 내용</li><li>서비스 이용 기록: 접속 및 이벤트 이용 기록 등 분석 도구를 통해 생성되는 정보</li></ul>
        <h2>2. 개인정보 이용 목적</h2><ul><li>레슨 일정 협의와 예약 처리</li><li>클래스 입금 확인과 Google Drive 이용 권한 제공</li><li>문의 답변과 고객 지원</li><li>서비스 오류 확인과 이용 현황 분석</li><li>부정 이용 방지와 분쟁 대응</li></ul>
