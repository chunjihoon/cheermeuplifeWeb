...
export default async function PostDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="posts-page">
      ...
      />
      <ContentCta title="직접 안무를 배워보고 싶나요?" description="현재 수준과 공연 목표에 맞는 레슨을 확인하거나 질풍가도 완전정복 클래스를 살펴보세요." primaryHref="/#products" primaryLabel="레슨 알아보기" secondaryHref="/vod-tutorial" secondaryLabel="질풍가도 완전정복 클래스" />
